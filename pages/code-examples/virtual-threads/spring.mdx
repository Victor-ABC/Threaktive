...
Um Virtual Threads vor Spring Boot 3.2 zu aktivieren, muss die Main-Klasse der Anwendung
(Enthält Aufruf von `SpringApplication#run` [^2]) angepasst werden. Hierfür werden zwei Methodenaufrufe benötigt.
...
Um virtuelle Threads ab Spring Boot 3.2 zu aktivieren, muss lediglich eine Eigenschaft in der
...
<em>
  ...
  RabbitMQ/Kafka-Listener und Spring Data Redis/Apache Pulsar-bezogene Integrationen auf virtuellen
  Threads. Diese Integrationen sind jedoch nicht Gegenstand dieses Beitrags.
</em>
...
[^2]: Siehe https://git.fh-muenster.de/fep-23-threaktive/fep_minimalistic/-/blob/feature/with-database/Virtual_Minimalistic_Microservice/src/main/java/com/example/gateway/GatewayApplication.java?ref_type=heads
[^3]: Siehe https://spring.io/blog/2023/09/09/all-together-now-spring-boot-3-2-graalvm-native-images-java-21-and-virtual/#spring-boot-32
