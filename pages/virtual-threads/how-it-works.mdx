...
import osVtHandlingImage from "./os_vt_handling.png"
...
<div className="box-center">
  <Image src={osVtHandlingImage} alt="Betriebssystem Handling mit Virtual Threads" />
  <span className="source">
    Abbildung X - Quelle: https://jenkov.com/tutorials/java-concurrency/java-virtual-threads.html
  </span>
</div>
