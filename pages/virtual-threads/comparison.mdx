...
import threadMappingImage from "./thread_mapping.png"
import virtualThreadMappingImage from "./virtual_thread_mapping.png"
...
<div className="box-center">
  <Image src={threadMappingImage} alt="Mapping: Platform Threads zu Betriebssystem Threads" />
  <span className="source">Abbildung X - Quelle: Eigene Anfertigung</span>
</div>
