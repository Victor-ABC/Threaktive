...
Neben dem Minimalistic Beispiel wurde noch ein weiteres Beispiel auf Virtuelle Threads umgestellt.
Die Anwendung besteht aus einem modularen Architekturansatz, der auf drei Microservices basiert.
...
Lasttests angewandt wurde. Hierbei wurden 100 virtuelle Benutzer (VU) über einen Zeitraum von 40 Minuten
simuliert. In diesem Kontext wurden die beiden Szenarien getestet: ein kleines, minimalistisches Beispiel,
welches lediglich simple Datenbankabfragen durchführt, sowie ein umfangreicheres Szenario, das näher an
praktischen Anwendungen liegt und neben Datenbanken auch Elemente wie RabbitMQ und Tokenhandling einschließt.
Beide Beispiele wurden jeweils mit normalen und virtuellen Threads entwickelt, um eine umfassende
...
unter steigender Belastung. Ergebnisse und Statuscodes der Anfragen werden überwacht, um
